    ...
    <>
      ...
      <section className="bg-gray-50 dark:bg-gray-950 py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Casual Card */}
            <div className="bg-white dark:bg-gray-900 rounded-lg border-2 border-gray-200 dark:border-white/10 p-8 hover:shadow-lg transition">
              <h3 className="text-2xl font-bold mb-2">Casual Player</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-6">Pay per slot</p>

              <div className="mb-6">
                <p className="text-sm text-gray-600 dark:text-gray-400">Perfect for:</p>
              ...
              <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-950 rounded">
              ...
              <Link
                href="/book"
                className="w-full block text-center bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-900 dark:text-white py-3 rounded-lg font-semibold transition"
              >
                Book Now
              </Link>
            </div>
            ...
            {/* Regular Card */}
            <div className="bg-white dark:bg-gray-900 rounded-lg border-2 border-purple-600 p-8 shadow-lg transform scale-105">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">10 slots per month</p>
              ...
              <div className="mb-6 p-4 bg-purple-50 dark:bg-purple-950/40 rounded">
                <p className="font-bold">Per Month:</p>
                <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">LKR 14,250</p>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg border-2 border-gray-200 dark:border-white/10 p-8 hover:shadow-lg transition">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">25 slots per month</p>
              ...
              <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-950 rounded">
                <p className="font-bold">Per Month:</p>
                <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">LKR 28,125</p>
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-2">
                  ~LKR 1,125 per session
                </p>
              </div>

              <button className="w-full bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-900 dark:text-white py-3 rounded-lg font-semibold transition">
                Subscribe Now
              </button>
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-yellow-50 dark:bg-yellow-950/40 border-2 border-yellow-200 dark:border-yellow-800/60 rounded-lg p-8">
          ...
          <div className="bg-green-50 dark:bg-green-950/40 border-2 border-green-200 dark:border-green-800/60 rounded-lg p-8">
            <div className="text-4xl mb-4">🏫</div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-white/10">
              ...
              <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">LKR 300/hour</p>
              <p className="text-xs text-gray-600 dark:text-gray-400 mt-2">or LKR 1,000/day</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-white/10">
              ...
              <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">Included</p>
              <p className="text-xs text-gray-600 dark:text-gray-400 mt-2">with all bookings</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-white/10">
              ...
              <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">LKR 200/day</p>
              <p className="text-xs text-gray-600 dark:text-gray-400 mt-2">Available at counter</p>
            </div>
          </div>
        </div>
      </section>
