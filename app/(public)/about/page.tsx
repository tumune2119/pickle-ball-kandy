    ...
    <>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="bg-linear-to-br from-purple-300 to-purple-400 h-96 rounded-lg flex items-center justify-center">
      ...
      <section className="bg-gray-50 dark:bg-gray-950 py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg border-l-4 border-purple-600">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg border-l-4 border-green-600">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-white/10 text-center hover:shadow-lg transition">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            >
              <div className="bg-linear-to-br from-purple-300 to-purple-400 h-48 flex items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <p className="text-purple-100">Year Founded</p>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">1</div>
              <p className="text-purple-100">Professional Court</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-purple-100">Booking Support</p>
            </div>
          </div>
        </div>
      </section>
